      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> Transactions stream via Kafka</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">SOC 2 · GLBA · BSA/AML · row-level access · column masking</span>
          </div>
